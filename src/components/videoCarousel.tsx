  ...
  return (
    <>
        ...
        {hightlightsSlides.map((list, i) => (
          <div key={list.id} id="slider" className="sm:pr-20 pr-10">
            <div className="relative sm:w-[70vw] w-[88vw] md:h-[70vh] sm:h-[50vh] h-[35vh]">
              <div className="size-full flex items-center justify-center rounded-3xl overflow-hidden bg-black">
                <video
                  id="video"
                  playsInline={true}
                  className={`${
      ...
      <div className="relative flex items-center justify-center mt-10">
        ...
        <button className="ml-4 p-4 rounded-full bg-gray-300 backdrop-blur flex items-center">
          <img
